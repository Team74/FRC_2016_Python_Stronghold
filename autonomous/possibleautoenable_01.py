...
[docs]        '''Called when the autonomous mode is disabled'''
        pass

    def done(self):

[docs]        '''Call this function to indicate that no more states should be called'''
        self.next_state(None)

    def next_state(self, name):

[docs]        '''Call this function to transition to the next state
...
[docs]        '''This function is called by the autonomous mode switcher, should
